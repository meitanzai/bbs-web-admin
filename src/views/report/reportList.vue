...
<template>
    <div class="main">
        <div class="navbar">
            ...
            <el-button type="primary" plain v-if="state.visible == 'false'" @click="reductionReport($event)">还原</el-button>
            ...
            <el-button type="primary" plain @click="deleteReport($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" fixed="right" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" v-if="scope.row.status==10" @click="processUI(scope.row)">处理</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/report/manage/edit', query:{ reportId : scope.row.id}})">修改</el-button>
                                <el-button type="primary" @click="deleteReport($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
                </el-table-column>
