        ...
        <div class="helpViewModule" v-if="state.help != undefined && state.help != null && Object.keys(state.help).length>0">
            <div class="help-wrap">
                ...
                <div class="operat">
                    ...
                    <el-link class="item" href="javascript:void(0);" @click="deleteHelp(state.help.id)">删除</el-link>
                </div>
                <div class="head">
                    <div class="title">
                        {{state.help.name}}
...
<script lang="ts" setup>
    ...
    import { processErrorInfo,getLanguageClassName, updateURLParameter } from '@/utils/tool';
