...
<template>
    <div class="main">
        <div class="navbar">
            ...
            <el-button type="primary" plain v-if="state.visible == 'false'" @click="reductionHelp($event)">还原</el-button>
            <el-button type="primary" plain v-if="state.visible == 'true'" @click="$router.push({path: '/admin/control/help/manage/add', query:{ visible : 'true',page:($route.query.page != undefined ? $route.query.page:'')}})">添加帮助</el-button>
            ...
            <el-button type="primary" plain v-if="state.visible == 'true'" @click="moveUI($event)">移动</el-button>
            <el-button type="primary" plain @click="deleteHelp($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/help/manage/view', query:{helpId : scope.row.id, visible : ($route.query.visible != undefined ? $route.query.visible:''),page : ($route.query.page != undefined ? $route.query.page:'')}})">查看</el-button>
                                <el-button type="primary" @click="deleteHelp($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
