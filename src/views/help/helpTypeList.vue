...
<template>
    <div class="main">
        ...
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/helpType/manage/add',query:{sourceParentId:($route.query.parentId != undefined ? $route.query.parentId:''),parentId : state.parentId, page:($route.query.page != undefined ? $route.query.page:'')}});">添加分类</el-button>
        </div>
        <div class="data-table" >
            <el-table :data="state.tableData" tooltip-effect="dark" style="width: 100%" @cell-click="cellExpandRow"  stripe empty-text="没有内容">
                ...
                <el-table-column label="操作" align="center" width="300">
                    <template #default="scope">
                        <el-button-group>
                            <el-button type="primary" @click="$router.push({path: '/admin/control/helpType/manage/add',query:{sourceParentId:($route.query.parentId != undefined ? $route.query.parentId:''), parentId: scope.row.id,page:($route.query.page != undefined ? $route.query.page:'')}});">添加子类</el-button>
                            <el-button type="primary" v-if="scope.row.childNodeNumber == 0" @click="$router.push({path: '/admin/control/helpType/manage/merger',query:{ sourceParentId:($route.query.parentId != undefined ? $route.query.parentId:''),typeId: scope.row.id,parentId: scope.row.parentId,page:($route.query.page != undefined ? $route.query.page:'')}});">合并</el-button>
                            <el-button type="primary" @click="$router.push({path: '/admin/control/helpType/manage/edit',query:{ sourceParentId:($route.query.parentId != undefined ? $route.query.parentId:''),typeId: scope.row.id,parentId: scope.row.parentId,page:($route.query.page != undefined ? $route.query.page:'')}});">修改</el-button>
