...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/filePackage/manage/package'});">打包文件</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="downloadStream($event,scope.row)">下载</el-button>
                                <el-button type="primary" @click="deleteFilePackage($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
