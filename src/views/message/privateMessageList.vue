                ...
                <el-table-column label="操作" align="center" width="150">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/privateMessage/manage/privateMessageChatList', query:{ friendUserId : scope.row.friendUserId, privateMessagePage:state.currentpage, id : $route.query.id,userName : encodeURIComponent(state.userName),beforeUrl:($route.query.beforeUrl != undefined ? $route.query.beforeUrl:'')}})">对话</el-button>
                                <el-button type="primary" @click="deletePrivateMessage($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
