...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/staff/manage/addStaff'});">添加员工</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="300">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/staffLoginLog/list', query:{ userId : scope.row.userId,staffPage:($route.query.page != undefined ? $route.query.page:'')}})">登录日志</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/staff/manage/editStaff', query:{ userId : scope.row.userId,page:($route.query.page != undefined ? $route.query.page:'')}})">修改</el-button>
                                <el-button type="primary" @click="deleteStaff($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
