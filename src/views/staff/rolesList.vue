...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/acl/manage/addRoles'});">添加角色</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="300">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/acl/manage/editRoles', query:{ rolesId : scope.row.id,page:($route.query.page != undefined ? $route.query.page:'')}})">修改</el-button>
                                <el-button type="primary" @click="deleteStaffRoles($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
