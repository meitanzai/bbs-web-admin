...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/thirdPartyLoginInterface/manage/add'});">添加第三方登录接口</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/thirdPartyLoginInterface/manage/edit', query:{ thirdPartyLoginInterfaceId : scope.row.id, page:state.currentpage}})">修改</el-button>
                                <el-button type="primary" @click="deleteThirdPartyLoginInterface($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
