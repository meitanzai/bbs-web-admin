...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/membershipCardGiftTask/manage/add'});">添加会员卡赠送任务</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="240">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/membershipCardGiftTask/manage/membershipCardGiftItemList', query:{ membershipCardGiftTaskId : scope.row.id}})">获赠用户</el-button>
                                <el-button type="primary" v-if="scope.row.type == 20" @click="$router.push({path: '/admin/control/membershipCardGiftTask/manage/view', query:{ membershipCardGiftTaskId : scope.row.id,page:($route.query.page != undefined ? $route.query.page:'')}})">查看</el-button>
                                <el-button type="primary" v-if="scope.row.type == 10" @click="$router.push({path: '/admin/control/membershipCardGiftTask/manage/edit', query:{ membershipCardGiftTaskId : scope.row.id,page:($route.query.page != undefined ? $route.query.page:'')}})">修改</el-button>
                                <el-button type="primary" @click="deleteMembershipCardGiftTask($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
