...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/dataBase/manage/backup'});">数据备份</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/dataBase/manage/reset', query:{ dateName : scope.row.fileName}});">还原</el-button>
                            </el-button-group>
                        </div>
                    </template>
