                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/feedback/manage/view', query:{ feedbackId : scope.row.id}})">查看</el-button>
                                <el-button type="primary" @click="deleteFeedback($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
