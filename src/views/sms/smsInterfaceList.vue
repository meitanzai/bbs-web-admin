...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/smsInterface/manage/add'});">添加短信接口</el-button>
        </div>
        <div class="data-table" >
            <el-table ref="multipleTable" :data="state.tableData" tooltip-effect="dark" style="width: 100%" stripe empty-text="没有内容">
                ...
                <el-table-column prop="uses" label="是否启用" align="center" min-width="100">
                    <template #default="scope">	
                        <el-switch v-model="state.enable[scope.$index]" @change="handleSmsChange(scope.row,scope.$index)"></el-switch>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/smsInterface/manage/edit', query:{ smsInterfaceId : scope.row.id, page:state.currentpage}})">修改</el-button>
                                <el-button type="primary" @click="deleteSmsInterface($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
