...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/disableUserName/manage/add',query:{ superiorPage:($route.query.page != undefined ? $route.query.page:'')}});">添加会员注册禁止用户名称</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/disableUserName/manage/edit', query:{ disableUserNameId : scope.row.id,superiorPage:($route.query.page != undefined ? $route.query.page:'')}})">修改</el-button>
                                <el-button type="primary" @click="deleteDisableUserName($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
