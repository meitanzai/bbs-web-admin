...
<template>
    <div class="main">
        <div class="navbar">
            ...
            <el-button type="primary" plain v-if="state.visible == 'true'" @click="$router.push({path: '/admin/control/user/manage/add', query:{ page:($route.query.page != undefined ? $route.query.page:'')}});">添加会员</el-button>
            ...
            <el-button type="primary" plain v-if="state.visible == 'false'" @click="reductionUser($event)">还原</el-button>
            <el-button type="primary" plain @click="deleteUser($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/user/manage/show', query:{ id : scope.row.id}})">查看</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/user/manage/edit', query:{ id : scope.row.id}})">修改</el-button>
                                <el-button type="primary" @click="deleteUser($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
