...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/userRole/manage/add'});">添加会员角色</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/userRole/manage/edit', query:{ userRoleId : scope.row.id}})">修改</el-button>
                                <el-button type="primary" @click="deleteUserRole($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
