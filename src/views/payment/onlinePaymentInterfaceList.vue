...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/onlinePaymentInterface/manage/add'});">添加在线支付接口</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="200">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/onlinePaymentInterface/manage/edit', query:{ onlinePaymentInterfaceId : scope.row.id, page:state.currentpage}})">修改</el-button>
                                <el-button type="primary" @click="deleteOnlinePaymentInterface($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
