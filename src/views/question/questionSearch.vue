...
<template>
    <div class="main">
        ...
        <div class="navbar" >
            <el-button type="primary" plain @click="reductionQuestion($event)">批量还原</el-button>
                ...
                <el-table-column label="操作" align="center" min-width="120">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/question/manage/view', query:{ questionId : scope.row.id}})">查看</el-button>
