...
<template>
    <div class="main">
        <div class="navbar">
            ...
            <el-button type="primary" plain v-if="state.visible == 'false'" @click="reductionQuestion($event)">还原</el-button>
            <el-button type="primary" plain v-if="state.visible == 'true'" @click="$router.push({path: '/admin/control/question/manage/add', query:{ visible : 'true',page:($route.query.page != undefined ? $route.query.page:'')}})">添加问题</el-button>
            ...
            <el-button type="primary" plain @click="deleteQuestion($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" min-width="120">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/question/manage/view', query:{ visible : ($route.query.visible != undefined ? $route.query.visible:''),questionId : scope.row.id}})">查看</el-button>
                                <el-button type="primary" @click="deleteQuestion($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
