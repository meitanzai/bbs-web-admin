...
<template>
    <div class="main">
        ...
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/questionTag/manage/add',query:{sourceParentId:($route.query.parentId != undefined ? $route.query.parentId:''), page:($route.query.page != undefined ? $route.query.page:'')}});">添加标签</el-button>
        </div>
