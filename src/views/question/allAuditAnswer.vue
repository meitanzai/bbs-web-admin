...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="deleteAnswer($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="150">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/question/manage/view', query:{ questionId : scope.row.questionId,answerId:scope.row.id}})">查看</el-button>
                                <el-button type="primary" @click="deleteAnswer($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
