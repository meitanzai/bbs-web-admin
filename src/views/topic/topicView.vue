                    ...
                    <div class="topicInfo clearfix" >
                        <div class="avatar">
                            <el-popover effect="light" trigger="hover" placement="top">
                                <template #default>
                                    <p v-if="state.topic.isStaff == false">呢称: {{state.topic.nickname}}</p>
            ...
            <div class="commentList">
                ...
                <div class="addComment" >
                    <el-form @submit.native.prevent>
                        ...
                        <el-form-item>
                            <el-button class="submitButton" size="large" type="primary" @mousedown.native="addCommentForm" :disabled="state.addCommentForm_disabled">提交</el-button>
