...
<template>
    <div class="main">
        <div class="navbar">
            ...
            <el-button type="primary" plain v-if="state.visible == 'false'" @click="reductionTopic($event)">还原</el-button>
            <el-button type="primary" plain v-if="state.visible == 'true'" @click="$router.push({path: '/admin/control/topic/manage/add', query:{ visible : 'true',page:($route.query.page != undefined ? $route.query.page:'')}})">添加话题</el-button>
            ...
            <el-button type="primary" plain @click="deleteTopic($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" min-width="110">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/topic/manage/view', query:{ visible : ($route.query.visible != undefined ? $route.query.visible:''),topicId : scope.row.id}})">查看</el-button>
                                <el-button type="primary" @click="deleteTopic($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
