...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="deleteComment($event,undefined)">批量删除</el-button>
        </div>
                ...
                <el-table-column label="操作" align="center" width="150">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="store.setCacheNumber();$router.push({path: '/admin/control/topic/manage/view', query:{ topicId : scope.row.topicId,commentId:scope.row.id}})">查看</el-button>
                                <el-button type="primary" @click="deleteComment($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
