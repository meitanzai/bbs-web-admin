...
<template>
    <div class="main">
        ...
        <div class="navbar">
            <el-button type="primary" plain @click="uploadUI($event)">模板压缩包上传</el-button>
                ...
                <el-table-column label="操作" align="center" width="450">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="templateDownload($event,scope.row)">下载</el-button>
                                <el-button type="primary" @click="directoryRenameUI($event,scope.row)">目录重命名</el-button>
                                <el-button type="primary" @click="importTemplate($event,scope.row)">解压到模板列表</el-button>
                                <el-button type="primary" @click="deleteExport($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
                </el-table-column>
