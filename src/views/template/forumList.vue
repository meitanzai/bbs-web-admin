...
<template>
    <div class="main">
        ...
        <div class="navbar">
            <el-button type="primary" plain :disabled="state.publicForum ==true" @click="$router.push({path: '/admin/control/forum/manage/add',query:{layoutId:$route.query.layoutId, dirName : $route.query.dirName,sourcePage:($route.query.sourcePage != undefined ? $route.query.sourcePage:''),page:($route.query.page != undefined ? $route.query.page:'')}});">添加版块</el-button>
        </div>
        <div class="data-table" >
            <el-table ref="multipleTable" :data="state.tableData" tooltip-effect="dark" style="width: 100%" stripe empty-text="没有内容">
                ...
                <el-table-column label="操作" align="center" width="250">
                    <template #default="scope">
                        <el-button-group>
                            <el-button type="primary" v-if="state.layout.returnData == 0" @click="editForumSourceUI($event,scope.row)">源码编辑</el-button>
                            <el-button type="primary" v-if="state.layout.returnData == 1" @click="editForumSourceUI($event,scope.row)">示例程序</el-button>
                            <el-button type="primary" @click="$router.push({path: '/admin/control/forum/manage/edit', query:{ layoutId : $route.query.layoutId,forumId : scope.row.id,dirName : $route.query.dirName,sourcePage:($route.query.sourcePage != undefined ? $route.query.sourcePage:''),page:($route.query.page != undefined ? $route.query.page:'')}})">修改</el-button>
                            <el-button type="primary" @click="deleteForum($event,scope.row)">删除</el-button>
                        </el-button-group>	
                    </template>
