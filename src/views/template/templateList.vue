...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/template/manage/add'});">添加模板</el-button>
            <el-button type="primary" plain @click="$router.push({path: '/admin/control/template/manage/importTemplateList'});">模板压缩包列表</el-button>
        </div>
        <div class="data-table" >
            <el-table ref="multipleTable" :data="state.tableData" tooltip-effect="dark" style="width: 100%" stripe empty-text="没有内容">
                ...
                <el-table-column prop="uses" label="当前使用中" align="center" min-width="100">
                    <template #default="scope">	
                        <el-switch v-model="state.uses[scope.$index]" @change="handleTemplateChange(scope.row,scope.$index)"></el-switch>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" align="center" width="480">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/forumCode/list', query:{ dirName : scope.row.dirName}})">版块代码</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/resource/list', query:{ dirName : scope.row.dirName}})">资源</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/layout/list', query:{ dirName : scope.row.dirName}})">布局</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/column/manage/list',query:{ dirName : scope.row.dirName}});">栏目</el-button>
                                <el-button type="primary" @click="exportTemplate($event,scope.row)">导出</el-button>
                                <el-button type="primary" @click="$router.push({path: '/admin/control/template/manage/edit', query:{ dirName : scope.row.dirName}})">修改</el-button>
                                <el-button type="primary" @click="deleteTemplate($event,scope.row)">删除</el-button>
                            </el-button-group>
                        </div>
                    </template>
                </el-table-column>
