        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                <el-form-item label="重建话题索引" :error="error.rebuildTopicIndex">
                    <el-button-group>
                        <el-button type="primary" @click="rebuildTopicIndex()">开始重建</el-button>
                    </el-button-group>
                    <div class="form-help" >需要时间取决于话题数量</div>
                </el-form-item>
                <el-form-item label="重建问题索引" :error="error.rebuildQuestionIndex">
                    <el-button-group>
                        <el-button type="primary" @click="rebuildQuestionIndex()">开始重建</el-button>
                    </el-button-group>
                ...
                <el-form-item label="清空系统所有缓存" :error="error.clearAllCache">
                    <el-button-group>
                        <el-button type="primary" @click="clearAllCache()">清空</el-button>
                    </el-button-group>
                </el-form-item>
                ...
                <el-form-item label="删除浏览量数据" :error="error.deletePageViewData_beforeTime" >
                    <div class="singleRowTable">
                        ...
                        <div class="rightCell">
                            <el-button-group>
                                <el-button type="primary" @click="deletePageViewData()">开始</el-button>
                            </el-button-group>
                        </div>
                    </div>
                ...
                <el-form-item label="删除用户登录日志数据" :error="error.deleteUserLoginLogData_beforeTime" >
                    <div class="singleRowTable">
                        ...
                        <div class="rightCell">
                            <el-button-group>
                                <el-button type="primary" @click="deleteUserLoginLogData()">开始</el-button>
                            </el-button-group>
                        </div>
                    </div>
