        ...
        <div class="data-table" >
            <el-table ref="multipleTable" :data="state.tableData" tooltip-effect="dark" style="width: 100%" stripe empty-text="没有内容">
                ...
                <el-table-column label="操作" align="center" width="100">
                    <template #default="scope">
                        <el-button-group>
                            <el-button type="primary" @click="$router.push({path: '/admin/control/redEnvelope/redEnvelopeAmountDistribution/list', query:{ giveRedEnvelopeId : scope.row.id, giveRedEnvelopePage:state.currentpage, id : $route.query.id,userName : encodeURIComponent(state.userName),beforeUrl:($route.query.beforeUrl != undefined ? $route.query.beforeUrl:'')}})">金额分配</el-button>
                        </el-button-group>
                    </template>
                </el-table-column>
            </el-table>
